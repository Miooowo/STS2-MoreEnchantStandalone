...
### 新增
- steam验证机制。
- 战斗附魔：**滑溜**（稀有，本场首次打出获得 2 滑溜）、**缓冲**（特殊，获得缓冲）、**复刻**（打出后置入消耗复制品于弃牌堆）、**熔融**（目标易伤层数翻倍）、**劫掠**（罕见，抽至非攻击）、**与我一战**（罕见，你+2 力量、敌人各+1 力量）、**恶魔护盾**（罕见，多人；消耗；自损 1；**自选队友**获得你当前格挡）、**死神**（稀有，仅伤害牌；攻击伤血施加一半伤害的灾厄）、**跃跃欲试**（罕见，耗能+1；按手牌攻击数获能）、**猛扑**（罕见，攻击且基础耗能≥2；下一张技能 0 费）、**夹击**（罕见，多人；耗能+1；夹击/侧袭效果）、**奇巧**（普通，获得奇巧关键词）。

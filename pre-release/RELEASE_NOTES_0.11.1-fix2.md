...
- Fixed `Demon Shield` teammate block transfer desync in multiplayer by explicitly synchronizing ally target selection (`ReserveChoiceId/SyncLocalChoice/WaitForRemoteChoice`) before block transfer.
